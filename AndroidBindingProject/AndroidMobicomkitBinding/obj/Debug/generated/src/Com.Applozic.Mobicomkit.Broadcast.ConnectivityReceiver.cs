...
namespace Com.Applozic.Mobicomkit.Broadcast {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.applozic.mobicomkit.broadcast']/class[@name='ConnectivityReceiver']"
	...
	public partial class ConnectivityReceiver : global::Android.Content.BroadcastReceiver {
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ConnectivityReceiver); }
		}

		protected ConnectivityReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.applozic.mobicomkit.broadcast']/class[@name='ConnectivityReceiver']/constructor[@name='ConnectivityReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (ConnectivityReceiver)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Applozic.Mobicomkit.Broadcast.ConnectivityReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Applozic.Mobicomkit.Broadcast.ConnectivityReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.broadcast']/class[@name='ConnectivityReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
