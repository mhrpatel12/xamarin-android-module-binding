...
#pragma warning restore 0169
		...
		static Delegate cb_addFilePart_Ljava_lang_String_Ljava_io_File_Landroid_os_Handler_;
#pragma warning disable 0169
		static Delegate GetAddFilePart_Ljava_lang_String_Ljava_io_File_Landroid_os_Handler_Handler ()
		{
			if (cb_addFilePart_Ljava_lang_String_Ljava_io_File_Landroid_os_Handler_ == null)
				cb_addFilePart_Ljava_lang_String_Ljava_io_File_Landroid_os_Handler_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr, IntPtr, IntPtr>) n_AddFilePart_Ljava_lang_String_Ljava_io_File_Landroid_os_Handler_);
			return cb_addFilePart_Ljava_lang_String_Ljava_io_File_Landroid_os_Handler_;
		}
...
#pragma warning restore 0169
		...
		static IntPtr id_addFilePart_Ljava_lang_String_Ljava_io_File_Landroid_os_Handler_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.api.attachment']/class[@name='ApplozicMultipartUtility']/method[@name='addFilePart' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.io.File'] and parameter[3][@type='android.os.Handler']]"
		[Register ("addFilePart", "(Ljava/lang/String;Ljava/io/File;Landroid/os/Handler;)V", "GetAddFilePart_Ljava_lang_String_Ljava_io_File_Landroid_os_Handler_Handler")]
