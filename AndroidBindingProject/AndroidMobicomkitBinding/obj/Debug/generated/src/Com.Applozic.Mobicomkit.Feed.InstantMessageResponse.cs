...
namespace Com.Applozic.Mobicomkit.Feed {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='InstantMessageResponse']"
	[global::Android.Runtime.Register ("com/applozic/mobicomkit/feed/InstantMessageResponse", DoNotGenerateAcw=true)]
	public partial class InstantMessageResponse : global::Com.Applozic.Mobicommons.Json.JsonMarker {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/applozic/mobicomkit/feed/InstantMessageResponse", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (InstantMessageResponse); }
		}

		protected InstantMessageResponse (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='InstantMessageResponse']/constructor[@name='InstantMessageResponse' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe InstantMessageResponse ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (InstantMessageResponse)) {
					SetHandle (
...
#pragma warning restore 0169
		...
		public virtual unsafe string Id {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='InstantMessageResponse']/method[@name='getId' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='InstantMessageResponse']/method[@name='setId' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Message {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='InstantMessageResponse']/method[@name='getMessage' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='InstantMessageResponse']/method[@name='setMessage' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe bool NotifyUser {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='InstantMessageResponse']/method[@name='isNotifyUser' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='InstantMessageResponse']/method[@name='setNotifyUser' and count(parameter)=1 and parameter[1][@type='boolean']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Type {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='InstantMessageResponse']/method[@name='getType' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='InstantMessageResponse']/method[@name='setType' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
