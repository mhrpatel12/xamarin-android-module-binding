...
namespace Org.Eclipse.Paho.Client.Mqttv3.Internal.Wire {
	...
	public partial class MqttPubComp : global::Org.Eclipse.Paho.Client.Mqttv3.Internal.Wire.MqttAck {
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/eclipse/paho/client/mqttv3/internal/wire/MqttPubComp", ref java_class_handle);
			}
		}
		...
		[Register (".ctor", "(I)V", "")]
		public unsafe MqttPubComp (int p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (MqttPubComp)) {
					SetHandle (
		...
		public unsafe MqttPubComp (global::Org.Eclipse.Paho.Client.Mqttv3.Internal.Wire.MqttPublish p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
		...
		[Register (".ctor", "(B[B)V", "")]
		public unsafe MqttPubComp (sbyte p0, byte[] p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
