...
namespace Com.Applozic.Mobicomkit.Broadcast {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.applozic.mobicomkit.broadcast']/class[@name='NotificationBroadcastReceiver']"
	[global::Android.Runtime.Register ("com/applozic/mobicomkit/broadcast/NotificationBroadcastReceiver", DoNotGenerateAcw=true)]
	public partial class NotificationBroadcastReceiver : global::Android.Content.BroadcastReceiver {


		static IntPtr LAUNCH_APP_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.applozic.mobicomkit.broadcast']/class[@name='NotificationBroadcastReceiver']/field[@name='LAUNCH_APP']"
		[Register ("LAUNCH_APP")]
		public static string LaunchApp {
			get {
				if (LAUNCH_APP_jfieldId == IntPtr.Zero)
					LAUNCH_APP_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "LAUNCH_APP", "Ljava/lang/String;");
				IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, LAUNCH_APP_jfieldId);
			...
			set {
				...
				try {
					JNIEnv.SetStaticField (class_ref, LAUNCH_APP_jfieldId, native_value);
				} finally {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.applozic.mobicomkit.broadcast']/class[@name='NotificationBroadcastReceiver']/field[@name='TAG']"
		[Register ("TAG")]
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/applozic/mobicomkit/broadcast/NotificationBroadcastReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (NotificationBroadcastReceiver); }
		}

		protected NotificationBroadcastReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.applozic.mobicomkit.broadcast']/class[@name='NotificationBroadcastReceiver']/constructor[@name='NotificationBroadcastReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe NotificationBroadcastReceiver ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (NotificationBroadcastReceiver)) {
					SetHandle (
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.broadcast']/class[@name='NotificationBroadcastReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
