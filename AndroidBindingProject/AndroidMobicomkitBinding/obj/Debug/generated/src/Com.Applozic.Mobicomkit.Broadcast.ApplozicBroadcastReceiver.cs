...
namespace Com.Applozic.Mobicomkit.Broadcast {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.applozic.mobicomkit.broadcast']/class[@name='ApplozicBroadcastReceiver']"
	[global::Android.Runtime.Register ("com/applozic/mobicomkit/broadcast/ApplozicBroadcastReceiver", DoNotGenerateAcw=true)]
	public partial class ApplozicBroadcastReceiver : global::Android.Content.BroadcastReceiver {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/applozic/mobicomkit/broadcast/ApplozicBroadcastReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ApplozicBroadcastReceiver); }
		}

		protected ApplozicBroadcastReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_content_Context_Lcom_applozic_mobicomkit_listners_ApplozicUIListener_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.applozic.mobicomkit.broadcast']/class[@name='ApplozicBroadcastReceiver']/constructor[@name='ApplozicBroadcastReceiver' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='com.applozic.mobicomkit.listners.ApplozicUIListener']]"
		[Register (".ctor", "(Landroid/content/Context;Lcom/applozic/mobicomkit/listners/ApplozicUIListener;)V", "")]
...
#pragma warning disable 0169
		...
		{
			global::Com.Applozic.Mobicomkit.Broadcast.ApplozicBroadcastReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Applozic.Mobicomkit.Broadcast.ApplozicBroadcastReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.broadcast']/class[@name='ApplozicBroadcastReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
