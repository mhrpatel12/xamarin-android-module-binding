...
namespace Org.Eclipse.Paho.Client.Mqttv3.Internal {
	...
	public partial class ClientDefaults : global::Java.Lang.Object {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/eclipse/paho/client/mqttv3/internal/ClientDefaults", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ClientDefaults); }
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (ClientDefaults)) {
					SetHandle (
