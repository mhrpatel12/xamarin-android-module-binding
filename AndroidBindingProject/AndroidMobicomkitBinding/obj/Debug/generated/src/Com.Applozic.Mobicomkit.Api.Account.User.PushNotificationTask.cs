...
namespace Com.Applozic.Mobicomkit.Api.Account.User {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.applozic.mobicomkit.api.account.user']/class[@name='PushNotificationTask']"
	[global::Android.Runtime.Register ("com/applozic/mobicomkit/api/account/user/PushNotificationTask", DoNotGenerateAcw=true)]
	public partial class PushNotificationTask : global::Android.OS.AsyncTask {

		// Metadata.xml XPath interface reference: path="/api/package[@name='com.applozic.mobicomkit.api.account.user']/interface[@name='PushNotificationTask.TaskListener']"
		[Register ("com/applozic/mobicomkit/api/account/user/PushNotificationTask$TaskListener", "", "Com.Applozic.Mobicomkit.Api.Account.User.PushNotificationTask/ITaskListenerInvoker")]
		public partial interface ITaskListener : IJavaObject {

			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.api.account.user']/interface[@name='PushNotificationTask.TaskListener']/method[@name='onFailure' and count(parameter)=2 and parameter[1][@type='com.applozic.mobicomkit.api.account.register.RegistrationResponse'] and parameter[2][@type='java.lang.Exception']]"
			[Register ("onFailure", "(Lcom/applozic/mobicomkit/api/account/register/RegistrationResponse;Ljava/lang/Exception;)V", "GetOnFailure_Lcom_applozic_mobicomkit_api_account_register_RegistrationResponse_Ljava_lang_Exception_Handler:Com.Applozic.Mobicomkit.Api.Account.User.PushNotificationTask/ITaskListenerInvoker, AndroidMobicomkitBinding")]
			void OnFailure (global::Com.Applozic.Mobicomkit.Api.Account.Register.RegistrationResponse p0, global::Java.Lang.Exception p1);

			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.api.account.user']/interface[@name='PushNotificationTask.TaskListener']/method[@name='onSuccess' and count(parameter)=1 and parameter[1][@type='com.applozic.mobicomkit.api.account.register.RegistrationResponse']]"
			[Register ("onSuccess", "(Lcom/applozic/mobicomkit/api/account/register/RegistrationResponse;)V", "GetOnSuccess_Lcom_applozic_mobicomkit_api_account_register_RegistrationResponse_Handler:Com.Applozic.Mobicomkit.Api.Account.User.PushNotificationTask/ITaskListenerInvoker, AndroidMobicomkitBinding")]
			void OnSuccess (global::Com.Applozic.Mobicomkit.Api.Account.Register.RegistrationResponse p0);

		}

		[global::Android.Runtime.Register ("com/applozic/mobicomkit/api/account/user/PushNotificationTask$TaskListener", DoNotGenerateAcw=true)]
		internal class ITaskListenerInvoker : global::Java.Lang.Object, ITaskListener {

			static IntPtr java_class_ref = JNIEnv.FindClass ("com/applozic/mobicomkit/api/account/user/PushNotificationTask$TaskListener");
			...
			static IntPtr Validate (IntPtr handle)
			{
				if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
					throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
								JNIEnv.GetClassNameFromInstance (handle), "com.applozic.mobicomkit.api.account.user.PushNotificationTask.TaskListener"));
				return handle;
			}
...
#pragma warning disable 0169
			...
			{
				global::Com.Applozic.Mobicomkit.Api.Account.User.PushNotificationTask.ITaskListener __this = global::Java.Lang.Object.GetObject<global::Com.Applozic.Mobicomkit.Api.Account.User.PushNotificationTask.ITaskListener> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public partial class SuccessEventArgs : global::System.EventArgs {
			...
			public SuccessEventArgs (global::Com.Applozic.Mobicomkit.Api.Account.Register.RegistrationResponse p0)
			{
				this.p0 = p0;
			}
		...
		[global::Android.Runtime.Register ("mono/com/applozic/mobicomkit/api/account/user/PushNotificationTask_TaskListenerImplementor")]
		internal sealed partial class ITaskListenerImplementor : global::Java.Lang.Object, ITaskListener {
			...
			public ITaskListenerImplementor (object sender)
				: base (
					global::Android.Runtime.JNIEnv.StartCreateInstance ("mono/com/applozic/mobicomkit/api/account/user/PushNotificationTask_TaskListenerImplementor", "()V"),
...
#pragma warning restore 0649
			...
			public void OnSuccess (global::Com.Applozic.Mobicomkit.Api.Account.Register.RegistrationResponse p0)
			{
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (PushNotificationTask); }
		}

		protected PushNotificationTask (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Lcom_applozic_mobicomkit_api_account_user_PushNotificationTask_TaskListener_Landroid_content_Context_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.applozic.mobicomkit.api.account.user']/class[@name='PushNotificationTask']/constructor[@name='PushNotificationTask' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='com.applozic.mobicomkit.api.account.user.PushNotificationTask.TaskListener'] and parameter[3][@type='android.content.Context']]"
		[Register (".ctor", "(Ljava/lang/String;Lcom/applozic/mobicomkit/api/account/user/PushNotificationTask$TaskListener;Landroid/content/Context;)V", "")]
		public unsafe PushNotificationTask (string p0, global::Com.Applozic.Mobicomkit.Api.Account.User.PushNotificationTask.ITaskListener p1, global::Android.Content.Context p2)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (PushNotificationTask)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Ljava/lang/String;Lcom/applozic/mobicomkit/api/account/user/PushNotificationTask$TaskListener;Landroid/content/Context;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Ljava/lang/String;Lcom/applozic/mobicomkit/api/account/user/PushNotificationTask$TaskListener;Landroid/content/Context;)V", __args);
					return;
				}

				if (id_ctor_Ljava_lang_String_Lcom_applozic_mobicomkit_api_account_user_PushNotificationTask_TaskListener_Landroid_content_Context_ == IntPtr.Zero)
					id_ctor_Ljava_lang_String_Lcom_applozic_mobicomkit_api_account_user_PushNotificationTask_TaskListener_Landroid_content_Context_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Ljava/lang/String;Lcom/applozic/mobicomkit/api/account/user/PushNotificationTask$TaskListener;Landroid/content/Context;)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Ljava_lang_String_Lcom_applozic_mobicomkit_api_account_user_PushNotificationTask_TaskListener_Landroid_content_Context_, __args),
						JniHandleOwnership.TransferLocalRef);
...
#pragma warning disable 0169
		...
		{
			global::Com.Applozic.Mobicomkit.Api.Account.User.PushNotificationTask __this = global::Java.Lang.Object.GetObject<global::Com.Applozic.Mobicomkit.Api.Account.User.PushNotificationTask> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.api.account.user']/class[@name='PushNotificationTask']/method[@name='doInBackground' and count(parameter)=1 and parameter[1][@type='java.lang.Void...']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.api.account.user']/class[@name='PushNotificationTask']/method[@name='onPostExecute' and count(parameter)=1 and parameter[1][@type='java.lang.Boolean']]"
