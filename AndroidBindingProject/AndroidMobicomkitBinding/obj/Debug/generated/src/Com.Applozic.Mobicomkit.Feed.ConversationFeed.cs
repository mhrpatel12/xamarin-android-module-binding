...
namespace Com.Applozic.Mobicomkit.Feed {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='ConversationFeed']"
	[global::Android.Runtime.Register ("com/applozic/mobicomkit/feed/ConversationFeed", DoNotGenerateAcw=true)]
	public partial class ConversationFeed : global::Com.Applozic.Mobicommons.Json.JsonMarker {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/applozic/mobicomkit/feed/ConversationFeed", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ConversationFeed); }
		}

		protected ConversationFeed (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='ConversationFeed']/constructor[@name='ConversationFeed' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe ConversationFeed ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (ConversationFeed)) {
					SetHandle (
...
#pragma warning restore 0169
		...
		public virtual unsafe global::System.Collections.Generic.IList<global::Com.Applozic.Mobicomkit.Feed.ErrorResponseFeed> ErrorResponse {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='ConversationFeed']/method[@name='getErrorResponse' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='ConversationFeed']/method[@name='setErrorResponse' and count(parameter)=1 and parameter[1][@type='java.util.List&lt;com.applozic.mobicomkit.feed.ErrorResponseFeed&gt;']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string GeneratedAt {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='ConversationFeed']/method[@name='getGeneratedAt' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='ConversationFeed']/method[@name='setGeneratedAt' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe bool IsSuccess {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='ConversationFeed']/method[@name='isSuccess' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Java.Lang.Object Response {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='ConversationFeed']/method[@name='getResponse' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Status {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='ConversationFeed']/method[@name='getStatus' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='ConversationFeed']/method[@name='setStatus' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		...
		static Delegate cb_setResponse_Lcom_applozic_mobicommons_people_channel_Conversation_;
#pragma warning disable 0169
		static Delegate GetSetResponse_Lcom_applozic_mobicommons_people_channel_Conversation_Handler ()
		{
			if (cb_setResponse_Lcom_applozic_mobicommons_people_channel_Conversation_ == null)
				cb_setResponse_Lcom_applozic_mobicommons_people_channel_Conversation_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_SetResponse_Lcom_applozic_mobicommons_people_channel_Conversation_);
			return cb_setResponse_Lcom_applozic_mobicommons_people_channel_Conversation_;
		}
...
#pragma warning restore 0169
		...
		static IntPtr id_setResponse_Lcom_applozic_mobicommons_people_channel_Conversation_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='ConversationFeed']/method[@name='setResponse' and count(parameter)=1 and parameter[1][@type='com.applozic.mobicommons.people.channel.Conversation']]"
		[Register ("setResponse", "(Lcom/applozic/mobicommons/people/channel/Conversation;)V", "GetSetResponse_Lcom_applozic_mobicommons_people_channel_Conversation_Handler")]
		public virtual unsafe void SetResponse (global::Com.Applozic.Mobicommons.People.Channel.Conversation p0)
		{
			if (id_setResponse_Lcom_applozic_mobicommons_people_channel_Conversation_ == IntPtr.Zero)
				id_setResponse_Lcom_applozic_mobicommons_people_channel_Conversation_ = JNIEnv.GetMethodID (class_ref, "setResponse", "(Lcom/applozic/mobicommons/people/channel/Conversation;)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);

				if (((object) this).GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_setResponse_Lcom_applozic_mobicommons_people_channel_Conversation_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setResponse", "(Lcom/applozic/mobicommons/people/channel/Conversation;)V"), __args);
			} finally {
			}
		}
