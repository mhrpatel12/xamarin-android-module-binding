...
namespace Com.Applozic.Mobicomkit.Feed {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='MqttMessageResponse']"
	[global::Android.Runtime.Register ("com/applozic/mobicomkit/feed/MqttMessageResponse", DoNotGenerateAcw=true)]
	public partial class MqttMessageResponse : global::Com.Applozic.Mobicommons.Json.JsonMarker {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/applozic/mobicomkit/feed/MqttMessageResponse", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (MqttMessageResponse); }
		}

		protected MqttMessageResponse (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='MqttMessageResponse']/constructor[@name='MqttMessageResponse' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe MqttMessageResponse ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (MqttMessageResponse)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Applozic.Mobicomkit.Feed.MqttMessageResponse __this = global::Java.Lang.Object.GetObject<global::Com.Applozic.Mobicomkit.Feed.MqttMessageResponse> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe string Id {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='MqttMessageResponse']/method[@name='getId' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='MqttMessageResponse']/method[@name='setId' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		static Delegate cb_setMessage_Ljava_lang_Object_;
#pragma warning disable 0169
		static Delegate GetSetMessage_Ljava_lang_Object_Handler ()
		{
			if (cb_setMessage_Ljava_lang_Object_ == null)
				cb_setMessage_Ljava_lang_Object_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_SetMessage_Ljava_lang_Object_);
			return cb_setMessage_Ljava_lang_Object_;
		}

		static void n_SetMessage_Ljava_lang_Object_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Com.Applozic.Mobicomkit.Feed.MqttMessageResponse __this = global::Java.Lang.Object.GetObject<global::Com.Applozic.Mobicomkit.Feed.MqttMessageResponse> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		static IntPtr id_setMessage_Ljava_lang_Object_;
		public virtual unsafe global::Java.Lang.Object Message {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='MqttMessageResponse']/method[@name='getMessage' and count(parameter)=0]"
			...
			get {
				...
				try {
					...
					if (((object) this).GetType () == ThresholdType)
						...
						return global::Java.Lang.Object.GetObject<global::Java.Lang.Object> (JNIEnv.CallNonvirtualObjectMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getMessage", "()Ljava/lang/Object;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='MqttMessageResponse']/method[@name='setMessage' and count(parameter)=1 and parameter[1][@type='java.lang.Object']]"
			[Register ("setMessage", "(Ljava/lang/Object;)V", "GetSetMessage_Ljava_lang_Object_Handler")]
			set {
				if (id_setMessage_Ljava_lang_Object_ == IntPtr.Zero)
					id_setMessage_Ljava_lang_Object_ = JNIEnv.GetMethodID (class_ref, "setMessage", "(Ljava/lang/Object;)V");
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);

					if (((object) this).GetType () == ThresholdType)
						JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_setMessage_Ljava_lang_Object_, __args);
					else
						JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setMessage", "(Ljava/lang/Object;)V"), __args);
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe bool NotifyUser {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='MqttMessageResponse']/method[@name='isNotifyUser' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='MqttMessageResponse']/method[@name='setNotifyUser' and count(parameter)=1 and parameter[1][@type='boolean']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Type {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='MqttMessageResponse']/method[@name='getType' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.feed']/class[@name='MqttMessageResponse']/method[@name='setType' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
