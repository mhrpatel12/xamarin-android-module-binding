...
namespace Org.Eclipse.Paho.Client.Mqttv3 {
	...
	public partial interface IMqttClient : IJavaObject {
		...
		string ClientId {
			...
			[Register ("getClientId", "()Ljava/lang/String;", "GetGetClientIdHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")] get;
		}
		...
		bool IsConnected {
			...
			[Register ("isConnected", "()Z", "GetIsConnectedHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")] get;
		}
		...
		string ServerURI {
			...
			[Register ("getServerURI", "()Ljava/lang/String;", "GetGetServerURIHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")] get;
		}
		...
		[Register ("close", "()V", "GetCloseHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")]
		void Close ();
		...
		[Register ("connect", "()V", "GetConnectHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")]
		void Connect ();
		...
		[Register ("connect", "(Lorg/eclipse/paho/client/mqttv3/MqttConnectOptions;)V", "GetConnect_Lorg_eclipse_paho_client_mqttv3_MqttConnectOptions_Handler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")]
		...
		[Register ("connectWithResult", "(Lorg/eclipse/paho/client/mqttv3/MqttConnectOptions;)Lorg/eclipse/paho/client/mqttv3/IMqttToken;", "GetConnectWithResult_Lorg_eclipse_paho_client_mqttv3_MqttConnectOptions_Handler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")]
		...
		[Register ("disconnect", "()V", "GetDisconnectHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")]
		void Disconnect ();
		...
		[Register ("disconnect", "(J)V", "GetDisconnect_JHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")]
		...
		[Register ("disconnectForcibly", "()V", "GetDisconnectForciblyHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")]
		...
		[Register ("disconnectForcibly", "(J)V", "GetDisconnectForcibly_JHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")]
		...
		[Register ("disconnectForcibly", "(JJ)V", "GetDisconnectForcibly_JJHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")]
		...
		[Register ("getPendingDeliveryTokens", "()[Lorg/eclipse/paho/client/mqttv3/IMqttDeliveryToken;", "GetGetPendingDeliveryTokensHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")]
		...
		[Register ("getTopic", "(Ljava/lang/String;)Lorg/eclipse/paho/client/mqttv3/MqttTopic;", "GetGetTopic_Ljava_lang_String_Handler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")]
		...
		[Register ("publish", "(Ljava/lang/String;[BIZ)V", "GetPublish_Ljava_lang_String_arrayBIZHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")]
		...
		[Register ("publish", "(Ljava/lang/String;Lorg/eclipse/paho/client/mqttv3/MqttMessage;)V", "GetPublish_Ljava_lang_String_Lorg_eclipse_paho_client_mqttv3_MqttMessage_Handler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")]
		...
		[Register ("setCallback", "(Lorg/eclipse/paho/client/mqttv3/MqttCallback;)V", "GetSetCallback_Lorg_eclipse_paho_client_mqttv3_MqttCallback_Handler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")]
		...
		[Register ("subscribe", "(Ljava/lang/String;)V", "GetSubscribe_Ljava_lang_String_Handler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")]
		...
		[Register ("subscribe", "(Ljava/lang/String;I)V", "GetSubscribe_Ljava_lang_String_IHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")]
		void Subscribe (string p0, int p1);

		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.paho.client.mqttv3']/interface[@name='IMqttClient']/method[@name='subscribe' and count(parameter)=1 and parameter[1][@type='java.lang.String[]']]"
		[Register ("subscribe", "([Ljava/lang/String;)V", "GetSubscribe_arrayLjava_lang_String_Handler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")]
		void Subscribe (string[] p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.paho.client.mqttv3']/interface[@name='IMqttClient']/method[@name='subscribe' and count(parameter)=2 and parameter[1][@type='java.lang.String[]'] and parameter[2][@type='int[]']]"
		[Register ("subscribe", "([Ljava/lang/String;[I)V", "GetSubscribe_arrayLjava_lang_String_arrayIHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")]
		void Subscribe (string[] p0, int[] p1);
		...
		[Register ("unsubscribe", "(Ljava/lang/String;)V", "GetUnsubscribe_Ljava_lang_String_Handler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")]
		void Unsubscribe (string p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.paho.client.mqttv3']/interface[@name='IMqttClient']/method[@name='unsubscribe' and count(parameter)=1 and parameter[1][@type='java.lang.String[]']]"
		[Register ("unsubscribe", "([Ljava/lang/String;)V", "GetUnsubscribe_arrayLjava_lang_String_Handler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientInvoker, AndroidMobicomkitBinding")]
		void Unsubscribe (string[] p0);
