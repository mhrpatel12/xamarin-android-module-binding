...
namespace Com.Applozic.Mobicomkit.Uiwidgets.Notification {

	// Metadata.xml XPath class reference: path="/api/package[@name='com.applozic.mobicomkit.uiwidgets.notification']/class[@name='MTNotificationBroadcastReceiver']"
	[global::Android.Runtime.Register ("com/applozic/mobicomkit/uiwidgets/notification/MTNotificationBroadcastReceiver", DoNotGenerateAcw=true)]
	public partial class MTNotificationBroadcastReceiver : global::Android.Content.BroadcastReceiver {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/applozic/mobicomkit/uiwidgets/notification/MTNotificationBroadcastReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (MTNotificationBroadcastReceiver); }
		}

		protected MTNotificationBroadcastReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.applozic.mobicomkit.uiwidgets.notification']/class[@name='MTNotificationBroadcastReceiver']/constructor[@name='MTNotificationBroadcastReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe MTNotificationBroadcastReceiver ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (MTNotificationBroadcastReceiver)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Applozic.Mobicomkit.Uiwidgets.Notification.MTNotificationBroadcastReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Applozic.Mobicomkit.Uiwidgets.Notification.MTNotificationBroadcastReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.applozic.mobicomkit.uiwidgets.notification']/class[@name='MTNotificationBroadcastReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
