...
namespace Org.Eclipse.Paho.Client.Mqttv3 {
	...
	public partial interface IMqttClientPersistence : IJavaObject {
		...
		[Register ("clear", "()V", "GetClearHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientPersistenceInvoker, MQTT")]
		void Clear ();
		...
		[Register ("close", "()V", "GetCloseHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientPersistenceInvoker, MQTT")]
		void Close ();
		...
		[Register ("containsKey", "(Ljava/lang/String;)Z", "GetContainsKey_Ljava_lang_String_Handler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientPersistenceInvoker, MQTT")]
		...
		[Register ("get", "(Ljava/lang/String;)Lorg/eclipse/paho/client/mqttv3/MqttPersistable;", "GetGet_Ljava_lang_String_Handler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientPersistenceInvoker, MQTT")]
		...
		[Register ("keys", "()Ljava/util/Enumeration;", "GetKeysHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientPersistenceInvoker, MQTT")]
		...
		[Register ("open", "(Ljava/lang/String;Ljava/lang/String;)V", "GetOpen_Ljava_lang_String_Ljava_lang_String_Handler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientPersistenceInvoker, MQTT")]
		...
		[Register ("put", "(Ljava/lang/String;Lorg/eclipse/paho/client/mqttv3/MqttPersistable;)V", "GetPut_Ljava_lang_String_Lorg_eclipse_paho_client_mqttv3_MqttPersistable_Handler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientPersistenceInvoker, MQTT")]
		...
		[Register ("remove", "(Ljava/lang/String;)V", "GetRemove_Ljava_lang_String_Handler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientPersistenceInvoker, MQTT")]
