...
namespace Org.Eclipse.Paho.Client.Mqttv3 {
	...
	public partial interface IMqttPersistable : IJavaObject {
		...
		int HeaderLength {
			...
			[Register ("getHeaderLength", "()I", "GetGetHeaderLengthHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttPersistableInvoker, MQTT")] get;
		}
		...
		int HeaderOffset {
			...
			[Register ("getHeaderOffset", "()I", "GetGetHeaderOffsetHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttPersistableInvoker, MQTT")] get;
		}
		...
		int PayloadLength {
			...
			[Register ("getPayloadLength", "()I", "GetGetPayloadLengthHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttPersistableInvoker, MQTT")] get;
		}
		...
		int PayloadOffset {
			...
			[Register ("getPayloadOffset", "()I", "GetGetPayloadOffsetHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttPersistableInvoker, MQTT")] get;
		}
		...
		[Register ("getHeaderBytes", "()[B", "GetGetHeaderBytesHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttPersistableInvoker, MQTT")]
		byte[] GetHeaderBytes ();
		...
		[Register ("getPayloadBytes", "()[B", "GetGetPayloadBytesHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttPersistableInvoker, MQTT")]
