...
namespace Org.Eclipse.Paho.Client.Mqttv3.Internal {
	...
	public partial interface INetworkModule : IJavaObject {
		...
		global::System.IO.Stream InputStream {
			...
			[Register ("getInputStream", "()Ljava/io/InputStream;", "GetGetInputStreamHandler:Org.Eclipse.Paho.Client.Mqttv3.Internal.INetworkModuleInvoker, MQTT")] get;
		}
		...
		global::System.IO.Stream OutputStream {
			...
			[Register ("getOutputStream", "()Ljava/io/OutputStream;", "GetGetOutputStreamHandler:Org.Eclipse.Paho.Client.Mqttv3.Internal.INetworkModuleInvoker, MQTT")] get;
		}
		...
		string ServerURI {
			...
			[Register ("getServerURI", "()Ljava/lang/String;", "GetGetServerURIHandler:Org.Eclipse.Paho.Client.Mqttv3.Internal.INetworkModuleInvoker, MQTT")] get;
		}
		...
		[Register ("start", "()V", "GetStartHandler:Org.Eclipse.Paho.Client.Mqttv3.Internal.INetworkModuleInvoker, MQTT")]
		void Start ();
		...
		[Register ("stop", "()V", "GetStopHandler:Org.Eclipse.Paho.Client.Mqttv3.Internal.INetworkModuleInvoker, MQTT")]
		void Stop ();

	}

	[global::Android.Runtime.Register ("org/eclipse/paho/client/mqttv3/internal/NetworkModule", DoNotGenerateAcw=true)]
	internal class INetworkModuleInvoker : global::Java.Lang.Object, INetworkModule {

		static IntPtr java_class_ref = JNIEnv.FindClass ("org/eclipse/paho/client/mqttv3/internal/NetworkModule");
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (INetworkModuleInvoker); }
		}
