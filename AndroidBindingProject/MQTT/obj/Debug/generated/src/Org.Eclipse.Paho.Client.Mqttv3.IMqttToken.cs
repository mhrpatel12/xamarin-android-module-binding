...
namespace Org.Eclipse.Paho.Client.Mqttv3 {
	...
	public partial interface IMqttToken : IJavaObject {
		...
		global::Org.Eclipse.Paho.Client.Mqttv3.IMqttActionListener ActionCallback {
			...
			[Register ("getActionCallback", "()Lorg/eclipse/paho/client/mqttv3/IMqttActionListener;", "GetGetActionCallbackHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttTokenInvoker, MQTT")] get;
			...
			[Register ("setActionCallback", "(Lorg/eclipse/paho/client/mqttv3/IMqttActionListener;)V", "GetSetActionCallback_Lorg_eclipse_paho_client_mqttv3_IMqttActionListener_Handler:Org.Eclipse.Paho.Client.Mqttv3.IMqttTokenInvoker, MQTT")] set;
		}
		...
		global::Org.Eclipse.Paho.Client.Mqttv3.IMqttAsyncClient Client {
			...
			[Register ("getClient", "()Lorg/eclipse/paho/client/mqttv3/IMqttAsyncClient;", "GetGetClientHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttTokenInvoker, MQTT")] get;
		}
		...
		global::Org.Eclipse.Paho.Client.Mqttv3.MqttException Exception {
			...
			[Register ("getException", "()Lorg/eclipse/paho/client/mqttv3/MqttException;", "GetGetExceptionHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttTokenInvoker, MQTT")] get;
		}
		...
		bool IsComplete {
			...
			[Register ("isComplete", "()Z", "GetIsCompleteHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttTokenInvoker, MQTT")] get;
		}
		...
		int MessageId {
			...
			[Register ("getMessageId", "()I", "GetGetMessageIdHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttTokenInvoker, MQTT")] get;
		}
		...
		global::Org.Eclipse.Paho.Client.Mqttv3.Internal.Wire.MqttWireMessage Response {
			...
			[Register ("getResponse", "()Lorg/eclipse/paho/client/mqttv3/internal/wire/MqttWireMessage;", "GetGetResponseHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttTokenInvoker, MQTT")] get;
		}
		...
		bool SessionPresent {
			...
			[Register ("getSessionPresent", "()Z", "GetGetSessionPresentHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttTokenInvoker, MQTT")] get;
		}
		...
		global::Java.Lang.Object UserContext {
			...
			[Register ("getUserContext", "()Ljava/lang/Object;", "GetGetUserContextHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttTokenInvoker, MQTT")] get;
			...
			[Register ("setUserContext", "(Ljava/lang/Object;)V", "GetSetUserContext_Ljava_lang_Object_Handler:Org.Eclipse.Paho.Client.Mqttv3.IMqttTokenInvoker, MQTT")] set;
		}
		...
		[Register ("getGrantedQos", "()[I", "GetGetGrantedQosHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttTokenInvoker, MQTT")]
		int[] GetGrantedQos ();
		...
		[Register ("getTopics", "()[Ljava/lang/String;", "GetGetTopicsHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttTokenInvoker, MQTT")]
		string[] GetTopics ();
		...
		[Register ("waitForCompletion", "()V", "GetWaitForCompletionHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttTokenInvoker, MQTT")]
		...
		[Register ("waitForCompletion", "(J)V", "GetWaitForCompletion_JHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttTokenInvoker, MQTT")]
