	...
	public partial class CircleImageView : global::Android.Widget.ImageView {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (CircleImageView)) {
					SetHandle (
		...
		public virtual unsafe bool BorderOverlay {
			...
			get {
				...
				try {
					...
					if (((object) this).GetType () == ThresholdType)
						return JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_isBorderOverlay);
					else
						return JNIEnv.CallNonvirtualBooleanMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "isBorderOverlay", "()Z"));
				} finally {
				}
			}
			...
			set {
				...
				try {
					...
					if (((object) this).GetType () == ThresholdType)
						JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_setBorderOverlay_Z, __args);
					else
						JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setBorderOverlay", "(Z)V"), __args);
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		static Delegate cb_isDisableCircularTransformation;
#pragma warning disable 0169
		static Delegate GetIsDisableCircularTransformationHandler ()
		{
			if (cb_isDisableCircularTransformation == null)
				cb_isDisableCircularTransformation = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, bool>) n_IsDisableCircularTransformation);
			return cb_isDisableCircularTransformation;
		}

		static bool n_IsDisableCircularTransformation (IntPtr jnienv, IntPtr native__this)
		{
			global::DE.Hdodenhof.Circleimageview.CircleImageView __this = global::Java.Lang.Object.GetObject<global::DE.Hdodenhof.Circleimageview.CircleImageView> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.DisableCircularTransformation;
		}
#pragma warning restore 0169

		static Delegate cb_setDisableCircularTransformation_Z;
#pragma warning disable 0169
		static Delegate GetSetDisableCircularTransformation_ZHandler ()
		{
			if (cb_setDisableCircularTransformation_Z == null)
				cb_setDisableCircularTransformation_Z = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, bool>) n_SetDisableCircularTransformation_Z);
			return cb_setDisableCircularTransformation_Z;
		}

		static void n_SetDisableCircularTransformation_Z (IntPtr jnienv, IntPtr native__this, bool p0)
		{
			global::DE.Hdodenhof.Circleimageview.CircleImageView __this = global::Java.Lang.Object.GetObject<global::DE.Hdodenhof.Circleimageview.CircleImageView> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.DisableCircularTransformation = p0;
		}
#pragma warning restore 0169

		static IntPtr id_isDisableCircularTransformation;
		static IntPtr id_setDisableCircularTransformation_Z;
		public virtual unsafe bool DisableCircularTransformation {
			// Metadata.xml XPath method reference: path="/api/package[@name='de.hdodenhof.circleimageview']/class[@name='CircleImageView']/method[@name='isDisableCircularTransformation' and count(parameter)=0]"
			[Register ("isDisableCircularTransformation", "()Z", "GetIsDisableCircularTransformationHandler")]
			get {
				if (id_isDisableCircularTransformation == IntPtr.Zero)
					id_isDisableCircularTransformation = JNIEnv.GetMethodID (class_ref, "isDisableCircularTransformation", "()Z");
				try {

					if (((object) this).GetType () == ThresholdType)
						return JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_isDisableCircularTransformation);
					else
						return JNIEnv.CallNonvirtualBooleanMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "isDisableCircularTransformation", "()Z"));
				} finally {
				}
			}
			// Metadata.xml XPath method reference: path="/api/package[@name='de.hdodenhof.circleimageview']/class[@name='CircleImageView']/method[@name='setDisableCircularTransformation' and count(parameter)=1 and parameter[1][@type='boolean']]"
			[Register ("setDisableCircularTransformation", "(Z)V", "GetSetDisableCircularTransformation_ZHandler")]
			set {
				if (id_setDisableCircularTransformation_Z == IntPtr.Zero)
					id_setDisableCircularTransformation_Z = JNIEnv.GetMethodID (class_ref, "setDisableCircularTransformation", "(Z)V");
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);

					if (((object) this).GetType () == ThresholdType)
						JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_setDisableCircularTransformation_Z, __args);
					else
						JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setDisableCircularTransformation", "(Z)V"), __args);
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe void SetBorderColorResource (int p0)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_setBorderColorResource_I, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setBorderColorResource", "(I)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe void SetFillColorResource (int p0)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_setFillColorResource_I, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setFillColorResource", "(I)V"), __args);
			} finally {
			}
		}
